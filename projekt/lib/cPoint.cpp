...
template class cPoint<complex<int>>;
template class cPoint<complex<long>>;
template class cPoint<complex<long long>>;
template class cPoint<complex<float>>;
template class cPoint<complex<double>>;